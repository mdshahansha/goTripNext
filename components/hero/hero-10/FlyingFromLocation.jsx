...
const FlyingFromLocation = ({ setFormData, formData }) => {
  const [searchValue, setSearchValue] = useState(formData.origin || "");
  ...
  const handleOptionClick = (item) => {
    ...
    setFormData((prevData) => ({ ...prevData, origin: item.name }));
  };
    ...
    <div className="searchMenu-loc px-24 lg:py-20 lg:px-0 js-form-dd js-liverSearch">
      ...
      <input
        ...
        onChange={(e) => {
          ...
          setFormData((prevData) => ({ ...prevData, origin: e.target.value }));
        }}
